...
{
    // Same matrix conversion as render_toolpaths(), but with the camera passed
    // in (the plater camera belongs to the on-screen canvas) and without any
    // ImGui/debug overlay - this draws into an offscreen FBO.
